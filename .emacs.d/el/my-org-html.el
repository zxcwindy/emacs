;;; my-org-html.el --- HTML export for Org-mode
...
(setf org-export-html-content-div "container")
(setf org-export-html-table-tag "<table class=\"table\">")
(setf org-export-table-header-tags '("<th>" . "</th>"))
(setf org-export-table-data-tags '("<td>" . "</td>"))


(defun my-org-export-as-html (arg &optional hidden ext-plist
...
"
	...
	(insert "<div class=\"container-fluid\">"
		(format "\n<div id=\"%s\" class=\"row-fluid\">"
	  ...
	  (progn
	    (push (format "<h%d>%s</h%d>\n"
			  ...
			  org-export-html-toplevel-hlevel)
		  thetoc)
	    (push "<div id=\"text-table-of-contents\" class=\"well sidebar-nav\">\n" thetoc)
	    (push "<ul class=\"nav nav-list\">\n<li>" thetoc)
	    (setq lines
		  (mapcar
		   #'(lambda (line)
	...
	(if (or (re-search-forward
	  ...
	  (when (looking-at "\\s-*</p>")
	    ...
	    (insert "\n")))
	(insert "<div id=\"table-of-contents\" class=\"span3\">\n")
	(let ((beg (point)))
	  (mapc 'insert thetoc)
	  (insert "</div>\n")
